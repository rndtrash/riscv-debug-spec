...
\title{Поддержка отладки в RISC-V\\
Версия \versionnum\\
\GITHash
}
\author{Редакторы оригинала: \\
Ernie Edgar \textless ernie.edgar@sifive.com\textgreater, SiFive, Inc. \\
Tim Newsome \textless tim@sifive.com\textgreater, SiFive, Inc. \\
Перевод: \\
Ivan Kuzmenko \textless https://github.com/rndtrash\textgreater }
\date{\GITAuthorDate}
\maketitle

Люди, внёсшие свой вклад во все версии данной спецификации, в
алфавитном порядке (пожалуйста, свяжитесь с редакторами для внесения поправок):
Bruce Ableidinger,
Krste Asanovi\'{c},
Peter Ashenden,
Allen Baum,
...
\markboth{Поддержка отладки в RISC-V Версия \versionnum}
{Поддержка отладки в RISC-V Версия \versionnum}
\thispagestyle{empty}
